...
`});var eM=pa(()=>{var M1=_(Kh());g1();b1();$e();S1();C1();A1();var E1=_(X());function WR(){let e=window;e.__xray_hud_capture__||(e.__xray_hud_capture__=!0,window.addEventListener("message",t=>{if(t.source!==window)return;let a=t.data;if(!a||!a.__xray_capture__)return;let o=e.__XRAY_BRIDGE_TOKEN__||e.__XRAY_bridgeToken;if(!o||a.token!==o)return;let r=I.getState();if(a.update&&a.entry){r.updateEntry(a.entry);return}if(a.batch&&Array.isArray(a.entries)){r.addEntries(a.entries.filter(Boolean));return}a.entry&&r.addEntry(a.entry)}))}async function T1(){let e=window,a=document.currentScript?.getRootNode?.(),o=e.__xrayHudShadow instanceof ShadowRoot?e.__xrayHudShadow:a instanceof ShadowRoot?a:null;if(!o)return;if(o.host instanceof HTMLElement&&I1(o.host),!o.querySelector("style[data-xray-hud-ui]")){let n=document.createElement("style");n.setAttribute("data-xray-hud-ui","1"),n.textContent=`${v1}
${w1}
${k1}`,o.appendChild(n)}let r=o.querySelector("#xray-hud-root");r||(r=document.createElement("div"),r.id="xray-hud-root",r.className="xray-app-root",o.appendChild(r)),WR(),await I.getState().restorePreferences(),I.getState().setOpen(!0),I.getState().setDevtoolsMode(!1),I.getState().setInitialized(!0),(0,M1.createRoot)(r).render((0,E1.jsx)(y1,{mode:"hud"})),JR(o)}var $R=["--xray-radius","--xray-bg","--xray-surface","--xray-surface2","--xray-text","--xray-accent"],R1=null;function JR(e){let t=e.host;if(!(t instanceof HTMLElement))return;let a=()=>{let n=e.querySelector(".xray-panel");if(!n)return;let l=getComputedStyle(n);for(let s of $R){let i=l.getPropertyValue(s).trim();i&&t.style.setProperty(s,i)}},o=0,r=()=>{o||(o=requestAnimationFrame(()=>{o=0,a()}))};requestAnimationFrame(()=>requestAnimationFrame(a)),R1?.(),R1=I.subscribe(r)}window.__xrayHudRemount=()=>{T1()};T1()});return eM();})();
